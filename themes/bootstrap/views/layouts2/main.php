                        ...
                        <li class="nav-header">
                            <div class="dropdown profile-element">
                                ...
                                <a data-toggle="dropdown" class="dropdown-toggle" href="#" style="text-align:center;">
                                    <span class="clear" style="height: 46px;">
                                        <span class="block m-t-sm"><strong class="font-bold"><?php if(!Yii::app()->user->isGuest) echo Yii::app()->user->name;?></strong></span> 
                                        <span class="text-muted text-xs block"><?php if(!Yii::app()->user->isGuest) echo Yii::app()->user->realName;?> <!--<b class="caret"></b>--></span>
                                    </span>
                                </a>
                            ...
                            <div class="logo-element">君顶<br/>华悦</div>
                        </li> 
                        <?php 
